...
You have finished the shortest closed loop. Pick by goal:

| Goal | Go to |
|------|------|
| Shared vocabulary and project config | [Glossary](../concepts/glossary), [luban.conf](../concepts/luban-conf), [groups/targets](../concepts/groups-targets) |
| Make Excel more complex | [Nesting and collections](../excel/nested-and-collections), [Polymorphism filling](../excel/polymorphism) |
| Define structure rigorously | [Excel Schema](../schema/excel-schema), [Types quick reference](../schema/types) |
